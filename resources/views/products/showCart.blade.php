                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href="/products/details/{{$item['data']['id']}}"><img src="{{asset('storage')}}/product_image/{{$item['data']['image']}}" alt="" width="150px" height="90px"></a>
                        </td>
                        ...
                        <td class="cart_delete">
                            <a class="cart_quantity_delete" onclick="return confirm('คุณต้องการลบสินค้าหรือไม่ ?')" href="/products/cart/deleteFromCart/{{$item['data']['id']}}"><i class="fa fa-times"></i></a>
                        </td>
                    @endforeach
                </tbody>
            </table>
